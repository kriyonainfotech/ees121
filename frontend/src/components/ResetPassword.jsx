...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const response = await axios.post(`${backend_API}/auth/reset-password`, {
        email,
        newPassword,
                  ...
                  <form action="" onSubmit={handleSubmit}>
                    <div className="mx-auto max-w-xs">
                      ...
                      <input
                        ...
                        className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-3" placeholder="New Password" />
