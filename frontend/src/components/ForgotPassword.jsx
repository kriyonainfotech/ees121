                ...
                <div className="w-full flex-1 mt-8">
                  ...
                  <form action="" onSubmit={handleSubmit}>
                    <div className="mx-auto max-w-xs">
                      <h5 className='text-center pb-3'>Forgot</h5>
                      ...
                      <input
                        ...
                        className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-3" placeholder="phone" />
